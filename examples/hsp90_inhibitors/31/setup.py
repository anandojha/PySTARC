#!/usr/bin/env python3
'''PySTARC setup for HSP90-inhibitor (31) - PDB-based, OpenEye+GAFF.'''
...
RXN_TARGETS_REC = [(37, 'CA', 'SER'), (40, 'CA', 'ALA'), (36, 'CA', 'ASN')]   # [(resid, 'CA', resname), ...]
RXN_TARGETS_LIG = [('O2x',), ('C15x',), ('N1x',)]   # [('O2x',), ...] - original espaloma atom names
...
print(f"Step 1: Extract protein + ligand from seekrflow PDB (31)")
