#!/usr/bin/env python3
'''PySTARC setup for HSP90-inhibitor (37) - PDB-based, OpenEye+GAFF.'''
...
RXN_TARGETS_LIG = [('C13x',), ('N2x',), ('O2x',)]   # [('O2x',), ...] - original espaloma atom names
...
print(f"Step 1: Extract protein + ligand from seekrflow PDB (37)")
