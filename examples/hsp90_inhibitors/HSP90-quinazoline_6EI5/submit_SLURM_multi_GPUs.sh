...
BASE=/mnt/ceph/users/aojha/PySTARC_simulations/hsp90_inhibitors/HSP90-quinazoline_6EI5
...
rm -f protein.prmtop protein.rst7 ligand.prmtop ligand.rst7 *.cache _full.rst7 sqm.out
python setup.py 
