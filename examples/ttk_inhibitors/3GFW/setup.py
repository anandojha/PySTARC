...
# User settings
PDB_ID                  = "3GFW"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "S22"                   # Ligand residue name in PDB
...
LIGAND_RESNAME          = "S22"                   # Ligand label for XML
...
# GLU603 O    <->  NAI  (7.0 A cutoff)
# GLY605 O    <->  OAQ  (7.0 A cutoff)
# GLY605 N    <->  NAF  (7.0 A cutoff)
RXN_TARGETS_REC         = [(603, 'O', 'GLU'), (605, 'O', 'GLY'), (605, 'N', 'GLY')]
RXN_TARGETS_LIG         = [('NAI',), ('OAQ',), ('NAF',)]
...
print(f"  ligand.pqr (Mps1-IN-1): {len(lig_lines)} atoms, Q={lig_charge:+.1f} e")
...
print(f"  Ligand:       Mps1-IN-1 ({len(lig_lines)} atoms, Q={lig_charge:+.1f} e)")
