...
# User settings
PDB_ID                  = "5LJJ"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "AD5"                   # Ligand residue name in PDB
...
LIGAND_RESNAME          = "AD5"                   # Ligand label for XML
...
# GLU603 O   (hinge acceptor)    <->  N9   (purine NH donor)
# GLY605 O   (hinge acceptor)    <->  N2   (purine NH2 donor)
# GLY605 N   (hinge donor)       <->  N3   (purine ring N acceptor)
# LYS529 NZ  (catalytic lysine)  <->  NBC  (morpholine N)
