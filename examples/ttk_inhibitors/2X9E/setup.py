...
# User settings
PDB_ID                  = "2X9E"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "SVE"                   # Ligand residue name in PDB
...
LIGAND_RESNAME          = "SVE"                   # Ligand label for XML
...
# GLU603 O    <->  N15  (7.0 A cutoff)
# GLY605 O    <->  N18  (7.0 A cutoff)
# GLY605 N    <->  N15  (7.0 A cutoff)
# LYS529 NZ   <->  O25  (7.0 A cutoff)
RXN_TARGETS_REC         = [(603, 'O', 'GLU'), (605, 'O', 'GLY'), (605, 'N', 'GLY')]
RXN_TARGETS_LIG         = [('N15',), ('N18',), ('N15',)]
...
print(f"  ligand.pqr (NMS-P715): {len(lig_lines)} atoms, Q={lig_charge:+.1f} e")
...
print(f"  Ligand:       NMS-P715 ({len(lig_lines)} atoms, Q={lig_charge:+.1f} e)")
