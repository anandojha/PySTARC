...
# User settings
PDB_ID                  = "5N84"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "8Q5"                   # Ligand residue name in PDB
...
LIGAND_RESNAME          = "8Q5"                   # Ligand label for XML
...
# GLU603 O    <->  NAL  (7.0 A cutoff)
# GLY605 O    <->  NAG  (7.0 A cutoff)
# GLY605 N    <->  NAL  (7.0 A cutoff)
# LYS529 NZ   <->  NAG  (10.0 A cutoff)
RXN_TARGETS_REC         = [(603, 'O', 'GLU'), (605, 'O', 'GLY'), (605, 'N', 'GLY')]
RXN_TARGETS_LIG         = [('NAL',), ('NAG',), ('NAL',)]
...
print(f"  ligand.pqr (Mps-BAY2b): {len(lig_lines)} atoms, Q={lig_charge:+.1f} e")
...
print(f"  Ligand:       Mps-BAY2b ({len(lig_lines)} atoms, Q={lig_charge:+.1f} e)")
