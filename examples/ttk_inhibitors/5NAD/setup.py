...
# User settings
PDB_ID                  = "5NAD"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "8RH"                   # Ligand residue name in PDB
REC_RESID_MIN           = 516                     # First protein residue (skip His-tag)
LIGAND_NET_CHARGE       = 0                       # Net charge of SB203580 at pH 7
RECEPTOR_RESNAME        = "TTK"                   # Receptor label for XML
LIGAND_RESNAME          = "8RH"                   # Ligand label for XML
...
# GLU603 O    <->  N7  (7.0 A cutoff)
# GLY605 O    <->  N10  (7.0 A cutoff)
# GLY605 N    <->  N7  (7.0 A cutoff)
# LYS529 NZ   <->  N10  (10.0 A cutoff)
RXN_TARGETS_REC         = [(603, 'O', 'GLU'), (605, 'O', 'GLY'), (605, 'N', 'GLY')]
RXN_TARGETS_LIG         = [('N7',), ('N10',), ('N7',)]
...
print(f"  ligand.pqr (BAY 1217389): {len(lig_lines)} atoms, Q={lig_charge:+.1f} e")
...
print(f"  Ligand:       BAY 1217389 ({len(lig_lines)} atoms, Q={lig_charge:+.1f} e)")
