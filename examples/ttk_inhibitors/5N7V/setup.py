...
# User settings
PDB_ID                  = "5N7V"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "8PT"                   # Ligand residue name in PDB
...
LIGAND_RESNAME          = "8PT"                   # Ligand label for XML
...
# GLU603 O    <->  N9  (7.0 A cutoff)
# GLY605 O    <->  N2  (7.0 A cutoff)
# GLY605 N    <->  N3  (7.0 A cutoff)
# LYS529 NZ   <->  NAT  (7.0 A cutoff)
RXN_TARGETS_REC         = [(603, 'O', 'GLU'), (605, 'O', 'GLY'), (605, 'N', 'GLY')]
RXN_TARGETS_LIG         = [('N9',), ('N2',), ('N3',)]
...
print(f"  ligand.pqr (MPI-0479605): {len(lig_lines)} atoms, Q={lig_charge:+.1f} e")
...
print(f"  Ligand:       MPI-0479605 ({len(lig_lines)} atoms, Q={lig_charge:+.1f} e)")
