...
# User settings
PDB_ID                  = "5N93"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "8QE"                   # Ligand residue name in PDB
...
LIGAND_RESNAME          = "8QE"                   # Ligand label for XML
...
# GLU603 O    <->  N14  (7.0 A cutoff)
# GLY605 O    <->  N7  (7.0 A cutoff)
# GLY605 N    <->  N7  (7.0 A cutoff)
# LYS529 NZ   <->  O22  (7.0 A cutoff)
RXN_TARGETS_REC         = [(603, 'O', 'GLU'), (605, 'O', 'GLY'), (605, 'N', 'GLY')]
RXN_TARGETS_LIG         = [('N14',), ('N7',), ('N7',)]
...
print(f"  ligand.pqr (TC-Mps1-12): {len(lig_lines)} atoms, Q={lig_charge:+.1f} e")
...
print(f"  Ligand:       TC-Mps1-12 ({len(lig_lines)} atoms, Q={lig_charge:+.1f} e)")
