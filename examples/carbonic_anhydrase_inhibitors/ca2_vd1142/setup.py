...
# User settings
PDB_ID                  = "3HS4"                  # PDB accession code
CHAIN_REC               = "A"                     # Protein chain ID in PDB
LIGAND_RESID            = "V13"                   # Ligand residue name
# Deprotonated AZM SMILES: sulfonamide NH- (charge -1)
LIGAND_SMILES           = "[NH-]S(=O)(=O)C1=C(F)C(NC2CCCCCCC2)=C(C(F)=C1F)S(=O)(=O)CCO"
LIGAND_NET_CHARGE       = -1                      # Net charge of deprotonated AZM
RECEPTOR_RESNAME        = "CA2"                  # Receptor label for XML
LIGAND_RESNAME          = "V13"                   # Ligand label for XML
...
RXN_TARGETS_REC         = [(199, 'OG1', 'THR'), (106, 'OE1', 'GLU')]
