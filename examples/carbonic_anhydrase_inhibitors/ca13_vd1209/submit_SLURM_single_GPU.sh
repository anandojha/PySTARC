...
BASE=/mnt/ceph/users/aojha/PySTARC_simulations/carbonic_anhydrase_inhibitors/ca13_vd1209
RUN=/mnt/home/aojha/ceph/PySTARC/run_pystarc.py

cd $BASE
rm -rf bd_sims
rm -f input.xml rxns.xml receptor.pqr ligand.pqr receptor.pdb ligand.pdb
rm -f protein.prmtop protein.rst7 ligand.prmtop ligand.rst7 *.cache _full.rst7 *.out
python setup.py
