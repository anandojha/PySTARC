...
# User settings
PDB_ID                  = "2NMX"                  # PDB accession code
...
RECEPTOR_RESNAME        = "CA1"                   # Receptor label for XML
...
RXN_TARGETS_REC         = [(197, 'OG1', 'THR'), (104, 'OE1', 'GLU')]
...
print(f"  Exp k_on (intrinsic): 2.7 x 10^6 M-1 s-1 (Linkuviene et al., 2018)")
print(f"  Exp k_on (observed):  2.7 x 10^6 M-1 s-1 (pH 7.0)")
print(f"\n  To run:")
