...
# R59 barnase -> ARG57 (NH1)  <->  E76 barstar -> GLU182 (OE1) Reaction criterion (Gabdoulline & Wade, 1997)
RXN_TARGETS_REC         = [(81, 'NH2', 'ARG'), (57, 'NH1', 'ARG')]
RXN_TARGETS_LIG         = [(147, 'OD1', 'ASP'), (182, 'OE1', 'GLU')]
...
print(f"  Exp k_on:     3-6 x 10^8 M-1 s-1")
print(f"  PySTARC k_on: 4.85 x 10^8 M-1 s-1 (validated)")
print(f"\n  To run:")
