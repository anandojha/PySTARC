...
|-----------|-------|-----------|
| b-surface radius | 10.0 Å | Combined maximum radii (1.0 + 1.0 = 2.0 Å) plus a buffer. |
...
| Parameter | Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Rationale |
|-----------|-------|-----------|
| b-surface radius | 45.0 Å | Combined maximum radii (28.4 + 3.7 = 32.1 Å) plus a buffer. |
...
| Parameter | Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Rationale |
|-----------|-------|-----------|
| b-surface radius | 30.0 Å | Combined maximum radii (8.6 + 3 ≈ 11.6 Å) plus a buffer. |
...
| Parameter | Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Rationale |
|-----------|-------|-----------|
| b-surface radius | 85.0 Å | Combined maximum radii (34.7 + 40.6 = 75.3 Å) plus a buffer. |
...
| Parameter | Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Rationale |
|-----------|-------|-----------|
| b-surface radius | 60.0 Å | Combined maximum radii (37.8 + 7.8 = 45.6 Å) plus a buffer. |
...
| Parameter | Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Rationale |
|-----------|-------|-----------|
| b-surface radius | 60.0 Å | Combined maximum radii (27 + 8 = 35 Å) plus a buffer. |
| Hydrodynamic radii | Auto-computed | From the PQR files via Monte Carlo surface integration. |
...
| Parameter | Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Rationale |
|-----------|-------|-----------|
| b-surface radius | 60.0 Å | Combined maximum radii of the two partners plus a buffer. |
| Hydrodynamic radii | Auto-computed | From the PQR files via Monte Carlo surface integration. |
| Debye length | 7.86 Å | 150 mM ionic strength. |
...
| Parameter | Value&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Rationale |
|-----------|-------|-----------|
| b-surface radius | 55.0 Å | Combined maximum radii of the two partners plus a buffer. |
| Hydrodynamic radii | Auto-computed | From the PQR files via Monte Carlo surface integration. |
| Debye length | 7.86 Å | 150 mM ionic strength. |
| APBS fine grid length | 144 Å | Covers ±72 Å. |
| APBS grid dimension | 257 | ~0.56 Å fine grid spacing. |
